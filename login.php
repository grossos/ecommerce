        ...
        <div class="card" style="margin-top: 100px;">
            <div class="card-body">
                <form action="login.php" method="post" enctype="multipart/form-data" >
                    ...
                    <div class="form-group">
                        <button type="submit" name="login" class="btn btn-success btn col-4">Login</button>
                    </div>
                    <div class="form-group">Don't have an account? <a href="register.php">Register Here</a></div>
                </form>
            </div>
        </div>
    </div>      
